...
class Payment extends Model
{
  ...
  */
  ...
  {
      return '<div class="user-block">
          <img class="img-circle" src="' . $this->offer->listing->product->image_square_tiny . '" alt="User Image">
          <span class="username"><a href="' . $this->offer->url .'" target="_blank">' . $this->offer->listing->product->name . '</a></span>
          <span class="description"><span class="label" style="background-color: '. $this->offer->listing->product->platform->color . '; margin-right: 10px;">' . $this->offer->listing->product->platform->name .'</span><i class="fa fa-calendar"></i> ' . $this->offer->listing->product->release_date->format('Y') . '</span>
      </div>';
  }
