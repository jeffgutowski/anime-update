...
class PaymentNew extends Notification
{
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ->subject(trans('notifications.offer_paid', ['gamename' => $this->offer->listing->product->name, 'username' => $this->offer->listing->user->name]))
            ->body(trans('notifications.push.offer_paid_message', ['gamename' => $this->offer->listing->product->name, 'username' => $this->offer->listing->user->name]))
