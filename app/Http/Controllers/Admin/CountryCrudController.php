...
class CountryCrudController extends CrudController
{
    public function setUp()
    {
        ...
        */
        ...
        $this->crud->addField(['name' => 'region_code', 'label'=> 'Region Code', 'type' => 'select_from_array',
            'options' => ['NTSC-U' => 'NTSC-U', 'NTSC-J' => 'NTSC-J', 'PAL' => 'PAL']
        ]);
        ...
        $this->crud->addColumn(['name' => 'code', 'label' => 'Country Code']);
        $this->crud->addColumn('region_code');
