...
<html class="no-js css-menubar{{ !Request::is('games') && !Request::is('listings') ? ' overflow-smooth' : '' }}{{ Request::is('messages') ? ' messages' : '' }}" lang="{{config('settings.default_locale')}}">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('themes/' . Theme::getCurrent() . '/assets/css/site.css') }}?version=1.4">
    <link rel="stylesheet" href="{{ asset('themes/' . Theme::getCurrent() . '/assets/css/site-light.css') }}?version=1.4">
          ...
          <div class="modal-body user-body">
            <div class="row no-space">
              <div class="col-md-6 social">
                <div class="logo">
                  <img src="{{ asset('themes/' . Theme::getCurrent() . '/assets/' . config('settings.logo')) }}" class="hires" />
                </div>
                <div class="buttons">
                  {{-- Sign in with twitch --}}
