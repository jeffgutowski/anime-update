...
@section('subheader')
  <div class="offer-subheader">
    ...
    @if(isset($trade_game))
    <div class="page-hero-bg-img-sell-overview" style="background: linear-gradient(90deg, rgba(247, 247, 247,0) 0, rgba(247, 247, 247,0) 20%, rgba(247, 247, 247,1) 50%, rgba(247, 247, 247,0) 80%, rgba(247, 247, 247,0) 100%), url('{{$game->image_cover}}') left 30% no-repeat, url('{{$trade_game->image_cover}}') right 30% no-repeat; background-size: cover, 50%, 50%;  "></div>
    @else
    <div class="page-hero-bg-img-sell-overview" style="background: linear-gradient(90deg, rgba(247, 247, 247,0) 0, rgba(247, 247, 247,0) 20%, rgba(247, 247, 247,1) 50%, rgba(247, 247, 247,0) 80%, rgba(247, 247, 247,0) 100%), url('{{$game->image_cover}}') left 30% no-repeat, url() right 30% no-repeat; background-size: cover, 50%, 50%;"></div>
    @endif
    {{-- Background color --}}
