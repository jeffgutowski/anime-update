...
@endphp
{{-- Start Notification --}}
<a class="notification hvr-grow-shadow2 {{ $notification->read_at ? 'grayscale' : '' }}" href="/friends" data-notif-id="{{$notification->id}}">
  <div class="icons">
  ...
  <div class="info">
    {{-- Notification text --}}
    <h1>
      {{ $friend->name }} has accepted your friend request.
    </h1>
