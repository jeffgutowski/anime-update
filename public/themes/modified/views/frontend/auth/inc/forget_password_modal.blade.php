        ...
        <div class="row no-space">
          <div class="col-md-12 form" id="loginform">
            ...
            <form id="forgetForm" method="POST" novalidate="novalidate">
              ...
              <button  class="btn btn-dark btn-block btn-animate btn-animate-vertical btn-success" id="forget" onclick="remember()">
...
<script>
  function remember() {
    $("#forget").addClass('btn-success').removeClass('btn-dark');
    setTimeout(function () {
      $("#forget").addClass('btn-dark').removeClass('btn-success');
    }, 2000)
  }
</script>
