      ...
      <div class="panel-body">
        ...
        <div class="input-group input-group-lg" id="search_bar">
          <div class="input-group-btn search-panel">
            ...
            @php
              $platforms = \App\Models\Platform::orderBy('name', 'asc')->get();
            @endphp
            <ul class="dropdown-menu systems" role="menu" style="max-height:300px; overflow-y:scroll;">
              @foreach($platforms as $platform)
              <li><a href="#{{ $platform->id }}" data-color="{{$platform->color}}">{{ $platform->name }}</a></li>
