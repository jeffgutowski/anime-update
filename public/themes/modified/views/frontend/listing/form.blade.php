...
@if(isset($game))
  <div style="margin-bottom: 16px; text-align: center">
    <span class="text m-r-10">Product information incorrect? </span> <a class="suggest-btn" target="_blank" href="{{ url('suggestion') .'/'. (isset($game) ? $game->id : '') }}" class="add-link"><i class="fa fa-pencil"></i> Suggest Edit</a>
  </div>
...
@else
  ...
  <section class="panel" id="select-game">
    ...
    <div class="panel-footer game-add">
      {{-- Link to game add --}}
      <div>
        <span class="text m-r-10">{{ trans('listings.form.game.not_found') }}</span> <a href="{{ url('suggestion')  }}" class="add-link"><i class="fa fa-pencil"></i> {{ trans('listings.form.game.add') }}</a>
      </div>
    </div>
    @endif
    ...
    <div class="panel-body">
      <div class="row no-space">
        ...
        <div class="form-group">
          ...
          <div>
            <span id="us-region-container" class="{{isset($game) && isset($game->ntsc_u) ? '' : 'hidden'}}">
              <input id="radio-us" type="radio" name="region" {{isset($game->ntsc_u) || isset($listing) && $listing->region == 'ntsc_u' ? 'checked' : ''}} value="ntsc_u">
              <label for="radio-us" class="region-label">
                NTSC-U
                <img class="" src="{{ asset('img/flags/US-moded.svg') }}" height="20"/>
              </label>
            </span>
            <span id="eu-region-container" class="{{isset($game) && isset($game->pal)  ? '' : 'hidden'}}">
              <input id="radio-eu" type="radio" name="region" {{isset($game->pal) && !isset($game->ntsc_u) || isset($listing) && $listing->region == 'pal' ? 'checked' : ''}} value="pal">
              <label for="radio-eu" class="region-label">
                PAL
                <img class=""  src="{{ asset('img/flags/EU.svg') }}" height="20"/>
              </label>
            </span>

            <span id="pa-region-container" class="{{isset($game) && isset($game->pa) ? '' : 'hidden'}}">
              <input id="radio-pa" type="radio" name="region" {{isset($game->pa) || isset($listing) && $listing->region == 'pa' ? 'checked' : ''}} value="pa">
              <label for="radio-pa" class="region-label">
                playasia
                <img class="" src="{{ asset('img/flags/Play-Asia.png') }}" height="20"/>
              </label>
            </span>
        ...
        {{-- Components --}}
        <div id="component-group" class="form-group {{isset($game) ? '' : 'hidden'}}">
          <label class="component-label">
            {{ trans('listings.general.components') }}
          </label>
        <div>
            @foreach(config('components.complete') as $component)
                <span class="component-wapper {{ isset($game) && !is_null($game->$component) ? '' : 'hidden' }}" id="{{$component}}-box" class="">
                  <input id="{{$component}}" type="checkbox" name="{{$component}}" class="component-checkbox" {{isset($listing) && $listing->$component ? 'checked' : ''}} {{isset($game) && !($game->$component) ? 'disabled' : ''}}/>
                  <label class="component-label {{isset($game) && !($game->$component) ? 'line-through' : ''}}" for="{{$component}}">{{ trans("games.components.$component") }}</label>
                </span>
            @endforeach
          ...
          <br/>
            <label class="component-label">
              {{ trans('listings.general.extra_components') }}
            </label>
          <div>
            @foreach(config('components.extra') as $component)
                <span class="component-wapper {{ (isset($game) && !is_null($game->$component)) ? '' : 'hidden' }}" id="{{$component}}-box">
                  <input id="{{$component}}" type="checkbox" name="{{$component}}" class="component-checkbox" {{isset($listing) && $listing->$component ? 'checked' : ''}} />
                  <label class="component-label" for="{{$component}}">{{ trans("games.components.$component") }}</label>
                </span>
            @endforeach
              <span id="extra-components">
                @if(isset($game) && $game->components)
                  @foreach($game->components as $component)
                    <span class="component-wapper {{ isset($game)  ? '' : 'hidden' }}" id="component-{{$component->name}}">
                      <input id="{{$component->name}}" type="checkbox" name="{{$component->name}}" class="component-checkbox" {{isset($listing) && isset($listing->components->{$component->name}) && $listing->components->{$component->name} ? 'checked' : ''}} {{ false ? 'checked' : ''}}/>
                      <label class="component-label" for="{{$component->name}}">{{ $component->name }}</label>
                    </span>
                  @endforeach
                @endif
            </span>
        ...
        <div class="form-group">
          ...
          <div>
            <input type="radio" id="condition-8" name="condition" value="8" {{ ( (isset($listing) &&  $listing->condition == 8) ? 'checked' : '') }}>
            <label class="condition" for="condition-8">{{ trans('listings.general.conditions.8')}}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.8')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-7" name="condition" value="7" {{ ( (isset($listing) &&  $listing->condition == 7) ? 'checked' : '') }}>
            <label class="condition" for="condition-7">{{ trans('listings.general.conditions.7')}}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.7')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-6" name="condition" value="6" {{ ( (isset($listing) &&  $listing->condition == 6) ? 'checked' : '') }}>
            <label class="condition" for="condition-6">{{ trans('listings.general.conditions.6')}}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.6')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-5" name="condition" value="5" {{ ( (isset($listing) &&  $listing->condition == 5) ? 'checked' : '') }}>
            <label class="condition" for="condition-5">{{ trans('listings.general.conditions.5') }}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.5')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-4" name="condition" value="4" {{ ( (isset($listing) &&  $listing->condition == 4) ? 'checked' : '') }}>
            <label class="condition" for="condition-4">{{ trans('listings.general.conditions.4') }}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.4')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-3" name="condition" value="3" {{ ( (isset($listing) &&  $listing->condition == 3 || !isset($listing)) ? 'checked' : '') }}>
            <label class="condition" for="condition-3">{{ trans('listings.general.conditions.3') }}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.3')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-2" name="condition" value="2" {{ ( (isset($listing) &&  $listing->condition == 2) ? 'checked' : '') }}>
            <label class="condition" for="condition-2">{{ trans('listings.general.conditions.2') }}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.2')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-1" name="condition" value="1" {{ ( (isset($listing) &&  $listing->condition == 1) ? 'checked' : '') }}>
            <label class="condition" for="condition-1">{{ trans('listings.general.conditions.1') }}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.1')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
            <input type="radio" id="condition-0" name="condition" value="0" {{ ( (isset($listing) && $listing->condition == 0) ? 'checked' : '') }}>
            <label class="condition" for="condition-0">{{ trans('listings.general.conditions.0') }}</label>
            <a href="#" class="condition-tip" data-toggle="tooltip" data-placement="right" title="{{ trans('listings.general.conditions_description.0')}}"><i class="fa fa-question-circle" aria-hidden="true"></i></a>
            <br>
          </div>
        </div>
        ...
        <div class="form-group row">
          {{-- Delivery --}}
          <div class="col-sm-6">
            <div class="checkbox-custom checkbox-default checkbox-lg" hidden>
  ...
  <section class="panel {{ !isset($listing) || isset($listing) && $listing->sell ? '' : 'hidden' }}" id="sell-panel">
    ...
    <div class="panel-heading sell">
      ...
      <div class="panel-heading-listing-form-content flex-center-space">
        <div>
          {{-- Panel Title --}}
          <h3 class="panel-title"><i class="fa fa-shopping-cart"></i><span class="hidden-xs-down"> {{ trans('listings.form.sell_title') }}</span></h3>
        </div>
        <div class="flex-center">
          {{-- Suggestion switch --}}
      ...
      <div class="modal-body" style="background-color: #191818;">
        ...
        <div class="main-content">
          ...
          <div class="input-group input-group-lg" id="search_bar">
            ...
            <input type="hidden" name="trade_search" value="1" id="trade_search">
...
<script id="selected-game" type="x-tmpl-mustache">
  <div id="suggest-edit" style="margin-bottom: 16px; text-align: center">
    <span class="text m-r-10">Product information incorrect? </span> <a class="suggest-btn" target="_blank" href="{{ url('suggestion')."/" }}<% id %>" class="add-link"><i class="fa fa-pencil"></i> Suggest Edit</a>
  </div>
    ...
    <div class="panel-body" >
      <div class="flex-center">
        ...
        <div>
            ...
            <span class="platform-label" style="background-color:<% platform_color %>; color: <% platform_text_color %>">
              <% platform_name %>
            </span>
        </div>
      </div>
...
@endif
  ...
  var listingGameSearch = new Bloodhound({
    ...
    remote: {
      url: '{{ url("product/search/json/%QUERY") }}',
      wildcard: '%QUERY'
    }
  });
  ...
  $('#offersearch').bind('typeahead:selected', function(obj, datum, name) {
    // regions
    $('#us-region-container').hide()
    $('#eu-region-container').hide()

    if (datum.ntsc_u !== null) {
      $('#us-region-container').show()
      $('#radio-us').attr('checked', 'checked')
    } else {
      $('#radio-eu').attr('checked', 'checked')
    }
    if (datum.pal !== null) {
      $('#eu-region-container').show()
    }

    // possible components on a game
    var components = {
      0:'disc',
      1:'cartridge',
      2:'box',
    ...
    // loop through components and only show components that can come with the game
    for(i = 0; i <= 12; i++) {
      let comp = $("#" + components[i] + "-box")
      let comp_checkbox = comp.find("input[name='" + components[i] + "']")
      if (datum[components[i]] === 1) {
        comp.show()
        comp_checkbox.attr("disabled", false)
        // unhide component group since we know that there are components on the game
        $("#component-group").show()
      } else if (datum[components[i]] === 0) {
        comp.show()
        comp_checkbox.attr("disabled", true)
      } else {
        comp.hide()
        comp_checkbox.attr("disabled", true)
      }
    }
    $("#extra-components").empty()
    if (datum.components) {
      $("#component-group").show()
      for(i = 0; i < datum.components.length; i++){
        $("#extra-components").append('<span class="component-wapper" id="component-'+datum.components[i].name+'">
                <input id="'+datum.components[i].name+'" type="checkbox" name="'+datum.components[i].name+'" class="component-checkbox" />
                <label class="component-label" for="'+datum.components[i].name+'"> '+datum.components[i].name+'</label>
              </span>'
        );
      }
    }
  ...
  $('a.condition-tip').on('click', function(e) {
    e.preventDefault();
  });
