  ...
  <div class="item-content">
    ...
    <div class="tab-pane fade" id="details" role="tabpanel">
      ...
      <div class="listing-values">
        ...
        {{-- Digital ditributor --}}
        <div class="value">
          <i class="fa fa-download" aria-hidden="true"></i> {{$listing->product->platform->digitals->where('id',$listing->digital)->first()->name}}
        </div>
        @else
        {{-- Condition --}}
        <div class="value">
        ...
        @foreach(config('components.all') as $component)
          @if(($listing->product->platform->$component))
            <div class="value">
              {{ trans("games.components.$component") }} <i class="fa @if($listing->$component) fa-check-circle text-success @else fa-times-circle text-danger @endif" aria-hidden="true"></i>
            </div>
          @endif
        @endforeach
        @foreach($listing->components as $component => $has)
            <div class="value">
              {{ $component }} <i class="fa @if($has) fa-check-circle text-success @else fa-times-circle text-danger @endif" aria-hidden="true"></i>
            </div>
        @endforeach
              ...
              <div class="modal-header">
                ...
                <div class="title">
                  ...
                  <h4 class="modal-title" id="myModalLabel">
                    ...
                    {!! trans('listings.modal_trade.trade_game' , ['game_name' => $listing->product->name]) !!}
                  </h4>
                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <div class="title">
                  ...
                  <h4 class="modal-title" id="myModalLabel">
                    <i class="fa fa-trash m-r-5" aria-hidden="true"></i>{{ trans('users.modal_delete_listing.title', ['gamename' => $listing->product->name]) }}
                  </h4>
                </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              ...
              <div class="title">
                ...
                <h4 class="modal-title" id="myModalLabel">
                  <i class="fa fa-shopping-cart m-r-5" aria-hidden="true"></i>
            ...
            <div class="modal-body">
              ...
              <div class="seperator"><span><i class="fa fa-shopping-cart" aria-hidden="true"></i></span></div>
              {{-- Start Buy Overview --}}
            ...
            <div class="modal-footer">
              ...
              <input name="game_id" type="hidden" value="{{  encrypt($game->id) }}">
              <input name="listing_id" type="hidden" value="{{ encrypt($listing->id) }}">
              <a style="position:relative; top:-3px"><img src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/buy-logo-large.png" alt="Buy now with PayPal" /></a>
              <a href="/cart/add?listing={{$listing->id}}" class="buy-button" style="margin-left: 14px; margin-top:7px">
                <span style="padding:7px"><i class="fa fa-shopping-cart" aria-hidden="true"></i> {{ trans('cart.add_to_cart') }}</span>
              </a>
            </div>
...
$(document).ready(function(){
   ...
   /*$.ajax({
   url : 'http://localhost/wiledia2/public/translate/en/de/{{$listing->product->description}}',
   type: 'GET',
