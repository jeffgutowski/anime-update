...
{
    $breadcrumbs->parent('platform_listings', $listing->product->platform);
    $breadcrumbs->push(trans('general.breadcrumbs.listing', ['username' => $listing->user->name, 'gamename' => $listing->product->name, 'platform' => $listing->product->platform->name ]), $listing->url_slug);
});
