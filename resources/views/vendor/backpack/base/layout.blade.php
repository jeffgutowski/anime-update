...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="{{ url('') }}" class="logo" style="background: linear-gradient(to right, #00d8ff , #ff5a00);">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><img src="{{ asset('img//logo.png') }}?v={{hash_file('md5', asset(config('settings.logo')))}}" ></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><img src="{{ asset('img//logo.png') }}?v={{hash_file('md5', asset(config('settings.logo')))}}" height="25" ></span>
        </a>
