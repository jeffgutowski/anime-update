...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    ...
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/settings/legal') }}"><i class="fa fa-university"></i> <span>Legal & Privacy</span></a></li>
  </ul>
</li>
@endcan
<!-- Language -->
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    ...
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/developer') }}"><i class="fa fa-edit" aria-hidden="true"></i> <span>Developers</span></a></li>
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/franchise') }}"><i class="fa fa-star" aria-hidden="true"></i> <span>Franchises</span></a></li>
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/genre') }}"><i class="fa fa-list-alt" aria-hidden="true"></i> <span>Genres</span></a></li>
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/publisher') }}"><i class="fa fa-book" aria-hidden="true"></i> <span>Publishers</span></a></li>
  </ul>
</li>
<li class="treeview">
  <a href="#"><i class="fa fa-keyboard-o"></i> <span>Accessories & Hardware</span> <i class="fa fa-angle-left pull-right"></i></a>
  <ul class="treeview-menu">
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/accessorieshardware') }}"><i class="fa fa-keyboard-o" aria-hidden="true"></i> <span>Products</span></a></li>
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/accessorieshardwaretype') }}"><i class="fa fa-list" aria-hidden="true"></i> <span>Types</span></a></li>
    <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/accessorieshardwarecompanies') }}"><i class="fa fa-book"></i> <span>Companies</span></a></li>
  </ul>
</li>
@endcan
@can('edit_trophies')
  <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/trophies') }}"><i class="fa fa-trophy"></i> <span>Trophies</span></a></li>
@endcan
...
@endcan
@can('edit_games')
  @php $unreviewed_suggestions = \App\Models\Suggestion::whereNull('reviewed_at')->count(); @endphp
  <li><a href="{{ url(config('backpack.base.route_prefix', 'admin').'/suggestion') }}"><i class="fa fa-pencil"></i> <span>Suggestion Reviews</span>@if($unreviewed_suggestions > 0) <span class="pull-right-container"> <span class="label label-danger pull-right">{{$unreviewed_suggestions}}</span> </span>@endif</a></li>
@endcan
@can('edit_listings')
