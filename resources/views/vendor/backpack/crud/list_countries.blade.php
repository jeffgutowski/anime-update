	        ...
	        <h4 class="modal-title" id="myModalLabel">Add country</h4>
		      ...
		      <div class="modal-body">
						...
						<select name="country_selection" id="country_selection" class="form-control select2">
				  		...
				  		<br/>
				  		<p>Please select country's region code.</p>
					    <select name="region_selection" id="region_selection" class="form-control">
							<option value=""></option>
	...
	<script>
			jQuery(document).ready(function($) {
			    ...
			    $("#add_country_form").submit(function(e){
			        ...
			        console.log('region_code', $('#region_code').val())
			        if($("#region_code").val() === "") {
						alert('Please select a region code!')
						return false;
					}
			    });
			});
